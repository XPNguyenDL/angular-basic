...
export class HousingService {
  ...
  // async getHousingLocationByKeyword(keyword: string) : Promise<HousingLocation[]>{
  //   const data = await fetch(this.url);
  ...
  //     h.state.toLowerCase().includes(keyword.toLowerCase())
  //   );
  //}

  getHousingLocationByKeyword(keyword: string) {
